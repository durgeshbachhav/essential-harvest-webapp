            ...
            <TabPanel>
              <div className="  px-4 md:px-0 mb-16">
                ...
                <div className="relative overflow-x-auto rounded-lg">
                  <table className="w-full text-sm text-left rounded-lg  bg-primary-300  ">
                    <thead
                      className="text-bold  border   uppercase rounded-lg "
                      //   style={{
                      //     backgroundColor: mode === "dark" ? "rgb(46 49 55)" : "",
                      //     color: mode === "dark" ? "white" : "",
                      //   }}
                      ...
                      return (
                        <tbody className="">
                          ...
                          >
                            ...
                            <td
                              className="px-6 py-4 text-heading-color font-bold "
                              style={{ color: mode === "dark" ? "white" : "" }}
                            >
                              {title}
                            </td>
                            ...
                            <td
                              className="px-6 py-4 text-heading-color font-medium "
                              style={{ color: mode === "dark" ? "white" : "" }}
                            >
                              {date}
                            </td>
