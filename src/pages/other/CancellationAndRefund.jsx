...
import { CancellationPolicy } from "../../customData/other/cancellationandrefund";
          ...
          <Layout>
               <div className="flex items-center justify-center flex-col py-20">
                    <div className="heading-content flex items-center justify-center flex-col gap-2">
                         <h4 className="secondary-font text-2xl">Refund And Cancellation</h4>
                         <img src={underline} alt="" />
                    </div>
                    <ul className="max-w-2xl mx-4 mt-20 divide-y gap-2">
                         {
                              Object.entries(CancellationPolicy).map(([sectionTitle, sectionContent]) => (
                                   <li key={sectionTitle}>
